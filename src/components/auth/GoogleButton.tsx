...
export const GoogleButton: React.FC<GoogleButtonProps> = ({ onClick, isLoading }) => {
    return (
        <motion.button
            ...
            onClick={onClick}
            disabled={isLoading}
            className="w-full relative flex items-center justify-center gap-3 px-4 py-3 bg-white/5 hover:bg-white/10 border border-white/20 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed group overflow-hidden"
        >
